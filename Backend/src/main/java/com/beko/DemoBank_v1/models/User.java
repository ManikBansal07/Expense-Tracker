...
public class User {
    ...
    // ✅ NEW: Relationship with Expenses
    ...
    public LocalDate getVerified_at() { return verified_at; }
    public void setVerified_at(LocalDate verified_at) { this.verified_at = verified_at; }
